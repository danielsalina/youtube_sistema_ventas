...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                        ...
                        <input type="hidden" name="name" value="estimate_new">
            ...
            <h1 class="text-center mt-4">Datos Del Presupuesto</h1>
            <div class="row d-flex justify-content-between">
                ...
                <div class="mx-5">
                    <div id="acciones_venta" class="form-group">
                        <a href="#" class="btn btn-danger mx-2" id="cancel_estimate_btn"><i class="fa fa-times" aria-hidden="true"></i> Anular Presupuesto</a>
                        <a href="#" class="btn btn-primary" id="estimate_btn"><i class="fa fa-dollar"></i> Generar Presupuesto</a>
                    </div>
                </div>
            </div>
            <div class="table-responsive">
                <table class="table table-hover">
                    <thead>
                        ...
                        <tr>
                            <td><input type="text" name="budget_product_code" id="budget_product_code"></td>
                            ...
                            <td class="text-center"><a href="#" id="add_product_estimate" class="btn btn-primary" style="display: none;"><i class="fa fa-check" aria-hidden="true"></i> Agregar</a></td>
                        </tr>
                        <tr style="background-color:#293846; color: #fff">
                            <th colspan="2">Nombre / Código del producto</th>
